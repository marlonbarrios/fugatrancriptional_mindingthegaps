...
// Function to get all supported languages for the menu
function getLanguagesForMenu() {
  return Object.keys(LANGUAGES); // Returns all supported languages
}
...
// Modify drawScrollingText function to handle vertical and horizontal text
