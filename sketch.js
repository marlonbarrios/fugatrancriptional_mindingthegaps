...
const sketch = p => {
  ...
  function drawReadingMode(p) {
    ...
    // Main text color - white for indigenous apologies (on black), white with transparency for others
    if (isIndigenousApology) {
      p.fill(255, 255, 255, 255); // Pure white for maximum respect and readability on black
    } else {
      p.fill(255, 255, 255, 240); // White with slight transparency for elegance on colored backgrounds
    }
